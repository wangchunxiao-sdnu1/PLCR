...
###########################
_C.DATALOADER = CN()
_C.DATALOADER.NUM_CLASS = 32  # 类别数目，可以覆盖更改
...
_C.DATALOADER.TRAIN_U.SAMPLER = "RandomSampler" #RandomSampler
...
_C.TEST.FINAL_MODEL = "last_step" #"last_step" #"best_val"

###########################
# Transforms para,used in SASR&coop
###########################
_C.TRANSFORMER = CN()
_C.TRANSFORMER.EMBED_DIM = 100  # embed_dim 1024
_C.TRANSFORMER.HIDDEN_UNIT = 50  # hidden_unit 512
_C.TRANSFORMER.DROPOUT_RATE = 0.2
_C.TRANSFORMER.NUM_HEADS = 1
_C.TRANSFORMER.MAX_LEN = 77
_C.TRANSFORMER.NUM_BLOCKS = 2
_C.TRANSFORMER.LR=0.001
_C.TRANSFORMER.DEVICE = "cuda"
###########################
# Trainer specifics
###########################
_C.TRAINER = CN()
